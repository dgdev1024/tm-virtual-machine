...
typedef enum TM_CPUInstruction
{
    ...
    TM_INST_JPB  = 0x2200, ///< @brief Jump by a specified offset.
    TM_INST_CALL = 0x2300, ///< @brief Call a subroutine at a specified address.
    TM_INST_RST  = 0x2400, ///< @brief Call one of 16 restart vector handlers.
    TM_INST_RET  = 0x2500, ///< @brief Return from a subroutine.
    TM_INST_RETI = 0x2600, ///< @brief Return from an interrupt.
    TM_INST_JPS  = 0x2700, ///< @brief Jump to the start of the program.
